...
void World::construct(void) {
	...
	Point3D v3(-5.0, 0.0, 0.0);
	Point3D v4(-55.0, 0.0, 0.0);
	Point3D v5(-30.0, 40.0, 0.0);
	Triangle* t2 = new Triangle(v3, v4, v5);
	Point3D v6(-25.0, 40.0, 0.0);
	Point3D v7(25.0, 40.0, 0.0);
	Point3D v8(0.0, 0.0, 0.0);
	...
	Point3D v12(35.0, 40.0, 0.0);
	Point3D v13(85.0, 40.0, 0.0);
	Point3D v14(60.0, 0.0, 0.0);
	...
	Point3D v18(-65.0, 0.0, 0.0);
	Point3D v19(-115.0, 0.0, 0.0);
	Point3D v20(-90.0, 40.0, 0.0);
	...
	Point3D v24(5.0,-5.0, 0.0);
	Point3D v25 (55.0, -5.0, 0.0);
	Point3D v26(30.0, -45.0, 0.0);
	...
	Point3D v33(-25.0, -50.0, 0.0);
	Point3D v34(25.0, -50.0, 0.0);
	...
	ptrLuzPuntual2->stablishUbication(0.0, -100.0, -200.0);
